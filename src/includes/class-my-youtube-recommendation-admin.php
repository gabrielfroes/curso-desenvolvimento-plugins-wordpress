<?php
class MyYoutubeRecommendationAdmin
{
    /**
    ...
    public function show_position_callback() {
        ...
        <fieldset>
	        ...
	        <label><input type="radio" name="show_position" value="after"<?php echo ( $value == 'after' ) ? 'checked="checked"' : '' ?>> <?php echo __('After Post') ?></label><br>
            <label><input type="radio" name="show_position" value="before"<?php echo ( $value == 'before' ) ? 'checked="checked"' : '' ?>> <?php echo __('Before Post') ?></label>
        </fieldset>
        <?php
    }
...
if( is_admin() )
    $my_yt_rec_admin_page = new MyYoutubeRecommendationAdmin();